package ug.co.absa.africa.async.notification.web.rest;

import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;
import static ug.co.absa.africa.async.notification.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import ug.co.absa.africa.async.notification.IntegrationTest;
import ug.co.absa.africa.async.notification.config.Constants;
import ug.co.absa.africa.async.notification.domain.User;
import ug.co.absa.africa.async.notification.repository.AuthorityRepository;
import ug.co.absa.africa.async.notification.repository.UserRepository;
import ug.co.absa.africa.async.notification.security.AuthoritiesConstants;
import ug.co.absa.africa.async.notification.service.UserService;
import ug.co.absa.africa.async.notification.service.dto.AdminUserDTO;
import ug.co.absa.africa.async.notification.service.dto.PasswordChangeDTO;
import ug.co.absa.africa.async.notification.service.dto.UserDTO;
import ug.co.absa.africa.async.notification.web.rest.vm.KeyAndPasswordVM;
import ug.co.absa.africa.async.notification.web.rest.vm.ManagedUserVM;
