package ug.co.absa.africa.async.notification.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ug.co.absa.africa.async.notification.service.EmailAlreadyUsedException ||
            ex instanceof ug.co.absa.africa.async.notification.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ug.co.absa.africa.async.notification.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(
            ...
            "io.",
            "de.",
            "ug.co.absa.africa.async.notification"
        );
    }
}
